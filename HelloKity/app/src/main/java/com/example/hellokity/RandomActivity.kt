...
class RandomActivity : AppCompatActivity() {
    ...
    lateinit var bindingClass: ActivityRandomBinding
    var n: Int = 0
    var m: Int = 0
    var arrA = arrayOf("")
    var arrB = arrayOf("")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingClass = ActivityRandomBinding.inflate(layoutInflater)
        ...
        inputRandom.inputClearTable1(n, m, arrA, arrB, bindingClass) //выводим начало
    ...
    fun onClickAdd(view: View) {
        root_matrix = input.inputtable1(root_matrix, n, m, arrA, arrB, bindingClass)
    }

    fun onClickGetRandom(view: View) {
        inputRandom.inputtable1(n, m, arrA, arrB, bindingClass)
    }
    ...
    fun onClickDelete(view: View) {
        ...
        when (p2Global){
            3->{ //NLO
                ...
                input.hideStrategy1(tempset3,tempset4,bindingClass)
            ...
            4 ->{ //Slab1
                ...
                if (tempset1.contains(delStrat)) {
                    ...
                    input.hideStrategy1(hideset, tempset2, bindingClass)
            ...
            5 -> { //Slab2
                ...
                if (tempset2.contains(delStrat)) {
                    ...
                    var hideset = mutableSetOf<Int>(hideStrat)
                    input.hideStrategy1(tempset1, hideset, bindingClass)
            ...
            6-> {
                ...
                input.hideStrategy1(tempset3,tempset2,bindingClass)
            }
            7 -> {
                //Sila2
                var tempset4: MutableSet<Int> = mutableSetOf<Int>()
                ...
                input.hideStrategy1(tempset1,tempset4,bindingClass)
